    ...
    extend: {
      ...
      keyframes: {
        ...
        "fly-to-cart": {
          ...
          "50%": { transform: "scale(0.5) translate(50%, -50%)", opacity: "0.8" },
          "100%": { transform: "scale(0) translate(100%, -100%)", opacity: "0" },
        },
      },
      animation: {
        ...
        "fly-to-cart": "fly-to-cart 0.6s cubic-bezier(0.4, 0, 0.2, 1)",
      },
    },
  },
